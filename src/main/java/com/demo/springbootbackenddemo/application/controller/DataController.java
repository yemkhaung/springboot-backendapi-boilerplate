...
public class DataController {
    ...
    public String list(Model model) {
        List<DataObject> dataList = this.dataQueryService.index().get();
    ...
    public String show(Model model, @PathVariable String id) {
        DataObject dataObj = this.dataQueryService.findById(id).get();
    ...
    public String edit(Model model, @PathVariable String id) {
        DataObject data = this.dataQueryService.findById(id).get();
